...
namespace Piechart
{
    public class Pie : Shape
    {
        ...
        public static readonly DependencyProperty RadianStartProperty = DependencyProperty.Register("RadianStart", typeof(Double), typeof(Pie), new FrameworkPropertyMetadata(-90d, FrameworkPropertyMetadataOptions.AffectsRender,
        ...
        private static void OnAutoAnimatablePropertyChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (e.OldValue is Double oldVal && e.NewValue is Double newVal)
                ((Pie)d).AutoAnimate(e.Property, oldVal, newVal);
        }

        /// <summary>
        /// 开始弧度
        /// </summary>
        public Double RadianStart
        {
            get => (Double)GetValue(RadianStartProperty); set => SetValue(RadianStartProperty, value);
        }
        ...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(double), typeof(Pie), new PropertyMetadata(0d, OnAutoAnimatablePropertyChangedCallback));



        public static readonly DependencyProperty RadianProperty = DependencyProperty.Register("Radian", typeof(Double), typeof(Pie), new FrameworkPropertyMetadata(0d, FrameworkPropertyMetadataOptions.AffectsRender,
            new PropertyChangedCallback(OnAutoAnimatablePropertyChangedCallback)));
        ...
        {
            get => (Double)GetValue(RadianProperty); set => SetValue(RadianProperty, value);
        }



        public static readonly DependencyProperty IsSectorProperty = DependencyProperty.Register("IsSector", typeof(Boolean), typeof(Pie), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.AffectsRender));
        ...
        {
            get => (Boolean)GetValue(IsSectorProperty); set => SetValue(IsSectorProperty, value);
        }



        public static readonly DependencyProperty IsAutoAnimateProperty = DependencyProperty.Register("IsAutoAnimate", typeof(Boolean), typeof(Pie), new PropertyMetadata(new PropertyChangedCallback(OnIsAutoAnimatePropertyChangedCallback)));
        ...
        {
            get => (Boolean)GetValue(IsAutoAnimateProperty); set => SetValue(IsAutoAnimateProperty, value);
        }
